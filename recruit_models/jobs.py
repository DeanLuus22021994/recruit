...
class Job(models.Model):
    ...
    employer: models.ForeignKey["Employer", "Job"] = models.ForeignKey(
    ...
    recruiter: models.ForeignKey["Recruiter", "Job"] = models.ForeignKey(
...
class JobRequirements(models.Model):
    ...
    job: models.OneToOneField[Job, "JobRequirements"] = models.OneToOneField(
    ...
    citizenship: models.ManyToManyField[Country] = models.ManyToManyField(
        Country, blank=True
    )
