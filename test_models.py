...
try:
    ...
    from recruit_models.candidates import Candidate, CandidateRequirements, CandidateDocument
    print("✓ candidates models imported successfully")
    
    from recruit_models.employers import Employer, EmployerRequirements, EmployerImages
    print("✓ employers models imported successfully")
    
    from recruit_models.interviews import InterviewInvitation, InterviewRequest, Available, Exclusion
    print("✓ interviews models imported successfully")
    
    from recruit_models.jobs import Job, Country
    ...
    from recruit_models.sendgrid import EmailTemplate, EmailLog
